    ...
    <div className="max-w-md mx-auto p-4 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
                ...
                onChange={(e) => setFormData({...formData, instructions: e.target.value})} required className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                />
            </div>
